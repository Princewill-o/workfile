...
public class TestResolver {
	...
	try {
	    ...
	    if (ns == null) {
		System.out.println("city.ac.uk. should have NS records.  That should work?");
		return;
	    } else {
		System.out.println("city.ac.uk.\tNS\t" + ns);
	    }

	    String ns2 = r.iterativeResolveName("google.com.", 2);
	    if (ns2 == null) {
		System.out.println("google.com. should have NS records.  That should work?");
		return;
	    } else {
		System.out.println("google.com.\tNS\t" + ns2);
	    }
	    ...
	    if (mx == null) {
		System.out.println("city.ac.uk. should have MX records.  That should work?");
		return;
	    } else {
		System.out.println("city.ac.uk.\tMX\t" + mx);
	    }

	    String mx2 = r.iterativeResolveName("google.com.", 15);
	    if (mx2 == null) {
		System.out.println("google.com. should have MX records.  That should work?");
		return;
	    } else {
		System.out.println("google.com.\tMX\t" + mx2);
	    }
